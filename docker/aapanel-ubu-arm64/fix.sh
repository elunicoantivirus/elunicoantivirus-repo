...
#docker exec -dit "ID-DE-TU-DOCKER AAPANEL SIN LAS COMILLAS DOBLES" /etc/init.d/bt reload


SERVICE=$

docker exec -dit bcfb24e567ba /etc/init.d/bt reload
...
echo "#                                                                                        #"
echo "#                                                                                        #"
echo "#     "50%/ERROR" "50%/ERROR" "50%/ERROR" "50%/ERROR" "50%/ERROR" "50%/ERROR" "50%/ERROR"#"
echo "#                                                                                        #"
echo "##########################################################################################"
echo 
fi
